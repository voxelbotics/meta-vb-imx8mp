...
do_install:append () {
    ...
    install -m 644 ${WORKDIR}/ov5640_af.bin ${D}${nonarch_base_libdir}/firmware
}

PACKAGES =+ "${PN}-ov5640"

FILES:${PN}-ov5640 = "${nonarch_base_libdir}/firmware/ov5640_af.bin"
